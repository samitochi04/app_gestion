...
export class Icon {
  ...
  private readonly paths: Record<string, string> = {
    ...
    'building': 'M4 21V4a1 1 0 0 1 1-1h9a1 1 0 0 1 1 1v17M15 9h4a1 1 0 0 1 1 1v11M8 7h2M8 11h2M8 15h2M3 21h18',
    'message-circle': 'M21 11.5a8.5 8.5 0 0 1-12.3 7.6L3 21l1.9-5.7A8.5 8.5 0 1 1 21 11.5Z',
    'send': 'M22 2 11 13M22 2l-7 20-4-9-9-4 20-7Z',
    'file-minus': 'M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6Zm0 0v6h6M9 15h6',
